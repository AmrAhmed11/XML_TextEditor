...
void BasicXMLSyntaxHighlighter::highlightBlock(const QString & text)
{
    ...
    highlightByRegex(m_xmlError1Format, m_xmlError1Regex, text);
    highlightByRegex(m_xmlError2Format, m_xmlError2Regex, text);
}
...
void BasicXMLSyntaxHighlighter::setRegexes()
{
    ...
    m_xmlError1Regex.setPattern("<!![^\\n]*>");
    m_xmlError2Regex.setPattern("</!![^\\n]*>");
...
void BasicXMLSyntaxHighlighter::setFormats()
{
    ...
    m_xmlError1Format.setForeground(Qt::red);
    m_xmlError2Format.setForeground(Qt::red);
}
